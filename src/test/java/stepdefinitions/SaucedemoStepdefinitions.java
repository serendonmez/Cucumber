...
saucedemoPage.passwordKutusu.sendKeys(password);
    ...
    ilkUrunText= saucedemoPage.ilkUrunIsimElementi.getText();
    ...
    public void sectigi_urunun_basarili_olarak_sepete_eklendigini_test_eder() {
        String expectedIlkUrun=ilkUrunText;
        String actualIlkUrun=saucedemoPage.sepettekiUrunIsimElementi.getText();
        Assertions.assertEquals(expectedIlkUrun,actualIlkUrun);
    }
